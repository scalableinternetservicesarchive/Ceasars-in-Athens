...
class AvailabilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create availability" do
    assert_difference('Availability.count') do
      post availabilities_url, params: { availability: { end: @availability.end, is_available: @availability.is_available, is_recurring: @availability.is_recurring, start: @availability.start, user_id: @availability.user_id } }
    end
  ...
  test "should update availability" do
    patch availability_url(@availability), params: { availability: { end: @availability.end, is_available: @availability.is_available, is_recurring: @availability.is_recurring, start: @availability.start, user_id: @availability.user_id } }
